...
/////////////////////////////////////////////////////
let btn_ready_register = document.querySelector("#btn__ready-register");
let mail_register = document.querySelector("#mail-register");
...
btn_ready_register.addEventListener('click', function () {
    ...
    if (mail_register.value == "" || user_register.value == "" || password_register.value == "" || password_confirm.value == "") {
    ...
    fetch(apiUrl)
        ...
        .then(json => {
            if (json.length > 0) {
                ...
                return nextClientId = lastClientId + 1;
            }
        })
